...
export const beginnerQuiz2Questions = [
    ...
    {
        type: QuestionType.MultipleChoice,
        question: "Which keyword prevents a property from being modified after initialization?",
        options: ["readonly", "const", "final", "immutable"],
    },
    // Question 3 - Objects & Interfaces (2 points)
    {
        type: QuestionType.TextInput,
        question: "What is the main difference between an interface and a type alias for defining object shapes?",
    },
    ...
    // Question 5 - Objects & Interfaces (3 points)
    {
        ...
        question: "Complete this interface definition with proper type annotations:",
        starterCode: 'interface GameCharacter {\n  name\n  health\n  level\n  isActive\n  inventory\n}\n\nconst player: GameCharacter = {\n  name: "Hero",\n  health: 100,\n  level: 5,\n  isActive: true,\n  inventory: ["sword", "shield"]\n};',
    },
    ...
    {
        type: QuestionType.TextInput,
        question: "What happens when you try to assign a value to a readonly property after object creation?",
    },
    // Question 8 - Objects & Interfaces (1 point)
    {
        type: QuestionType.MultipleChoice,
        question: "Which syntax is used to extend an interface from another interface?",
        options: [
    ...
    {
        type: QuestionType.CodeCompletion,
        question: "Create an interface 'Vehicle' with properties: brand (string), year (number), isElectric (optional boolean). Then create an interface 'Car' that extends Vehicle and adds 'doors' (number):",
        starterCode: "",
    },
    // Question 10 - Objects & Interfaces (2 points)
    {
        type: QuestionType.TextInput,
        question: "When should you use an interface versus a type alias in TypeScript?",
    },
    ...
    {
        type: QuestionType.TextInput,
        question: "Why should function parameters always have explicit type annotations even when TypeScript has inference?",
    },
    ...
    {
        type: QuestionType.CodeCompletion,
        question: "Write a generic function 'wrapInArray' that takes a value of any type and returns an array containing that value:",
        starterCode: "",
    },
    // Question 16 - Type Inference & Generics (4 points)
    {
        type: QuestionType.CodeCompletion,
        question: "Create a generic class 'DataStore<T>' with private property 'items' (array of T), and methods: 'add(item: T): void', 'getAll(): T[]', and 'findById(id: number): T | undefined'. The items should have an 'id' property:",
        starterCode: "",
    },
    // Question 17 - Type Inference & Generics (3 points)
    {
        type: QuestionType.CodeCompletion,
        question: "Create a generic interface 'Result<T>' with properties: success (boolean), data (T), and message (string). Then create a variable of type Result<number>:",
        starterCode: "",
    },
    // Question 18 - Type Inference & Generics (2 points)
    {
        type: QuestionType.TextInput,
        question: "What is the conventional naming for generic type parameters and why?",
    },
    // Question 19 - Type Inference & Generics (3 points)
    {
        type: QuestionType.CodeCompletion,
        question: "Write a generic function 'getLastElement' that takes an array of any type and returns the last element (or undefined if empty):",
        starterCode: "",
    },
...
//# sourceMappingURL=beginnerQuiz2Questions.js.map