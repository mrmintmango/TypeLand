    ...
    initializeQuestions() {
        this.questions = [
            ...
            // Question 2 - Variables and Primitive Types (2 points)
            {
                ...
                question: "List the TypeScript primitive types that are distinct from JavaScript runtime types and briefly state one purpose of TypeScript primitives.",
            ...
            {
                type: QuestionType.MultipleChoice,
                question: "What is the result type of 'typeof null' at runtime in JavaScript and how does TypeScript treat null by default under --strictNullChecks?",
                options: [
            ...
            {
                type: QuestionType.CodeCompletion,
                question: 'Add TypeScript types and a generic so identity preserves the input type:\n\nfunction identity(x) {\n  return x;\n}\n\nconst a = identity(5);\nconst b = identity("hello");\n\nProvide the corrected code.',
            ...
            {
                type: QuestionType.TextInput,
                question: "Explain the difference between an index signature and mapped types in one sentence.",
