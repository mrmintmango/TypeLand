...
export const beginnerQuiz1Questions: QuizQuestion[] = [
  ...
  // Question 2 - Variables and Basic Types (1 point)
  {
    type: QuestionType.MultipleChoice,
    question:
      "What is the correct syntax for declaring a variable with type annotation?",
    options: [
  ...
  // Question 3 - Variables and Basic Types (2 points)
  {
    ...
    question:
      "Explain the difference between 'let' and 'const' in one sentence.",
  },
  ...
  // Question 8 - Functions (1 point)
  {
    type: QuestionType.MultipleChoice,
    question:
      "What is the correct syntax for a function parameter with a type annotation?",
    options: [
  ...
  // Question 9 - Functions (3 points)
  {
    type: QuestionType.CodeCompletion,
    question:
      "Write a function 'calculateArea' that takes width and height as numbers and returns a number:",
    starterCode: "",
  },
  ...
  // Question 10 - Functions (2 points)
  {
    type: QuestionType.TextInput,
    question:
      "What is the difference between a required parameter and an optional parameter in TypeScript functions?",
  },
  ...
  // Question 12 - Functions (1 point)
  {
    type: QuestionType.MultipleChoice,
    question:
      "Which arrow function syntax is correct for a function that takes two numbers and returns a number?",
    options: [
  ...
  // Question 14 - Functions (4 points)
  {
    type: QuestionType.CodeCompletion,
    question:
      "Create a function 'formatName' that takes firstName (required), lastName (required), and middleName (optional) as strings, and returns a formatted full name:",
    starterCode: "",
  },
  ...
  // Question 17 - Arrays and Tuples (3 points)
  {
    type: QuestionType.CodeCompletion,
    question:
      "Create a tuple type 'PlayerInfo' for [username: string, level: number, isOnline: boolean] and declare a variable of that type:",
    starterCode: "",
  },
  ...
  // Question 18 - Arrays and Tuples (2 points)
  {
    type: QuestionType.TextInput,
    question:
      "Which array method would you use to transform each element in an array to a new value while maintaining type safety?",
  },
  ...
  // Question 19 - Arrays and Tuples (3 points)
  {
    type: QuestionType.CodeCompletion,
    question:
      "Write code that filters an array of numbers to only include even numbers:",
    starterCode:
